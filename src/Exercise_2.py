...
"""
filename="/Users/yijiewang/Documents/WINTER 2024/PHY294/EX2.txt"
"""
...
color="blue", markersize=5)
    ...
    ax1.set_xlabel("Intensity (I_0)")
    ax1.set_ylabel("Photocurrent (V)")
    ax1.set_title("Graph of Photocurrent VS Intensity")
    # ax1.set_xlim([0, 0.12])
...
########### HERE!!! ##############
    ...
    ax2.set_xlabel("Intensity (I_0)")
    ax2.set_ylabel("Photocurrent (V)")
